...
- **Provider-pluggable.** Use a configured local OpenAI-compatible model server or an OpenAI API key. Codex entitlement inference remains pending verified context isolation.
...
does not automatically switch providers. See [provider setup and E10 investigation](docs/PROVIDERS.md).
